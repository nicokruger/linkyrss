# https://github.com/topicaxis/opengraph/blob/master/opengraph/opengraph.py
# i couldn't get it to work from pip
...
class OpenGraph(dict):
    ...
    # change made by me - we only care about a title or description ?
    required_attrs = []
